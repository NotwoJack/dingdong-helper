...
public class UserConfig {
    ...
    //收货地址id
    public static final String addressId = "5cbe9ab5b3e6fe5bf6b81e30";
    ...
    public static Map<String, String> getHeaders() {
        ...
        headers.put("ddmc-device-id", "osP8I0Ye4h8s02pKunY83P4e9Sc8");
        headers.put("ddmc-station-id", "5b8d22f8c0a1ea3a278b8b7c");//这个是站点id 请仔细检查和确认这个参数 进入小程序之后首页左上角是不是你所在的站点 如果不是先选择好站点再抓包 不要把站点搞错了 否则不能下单
        headers.put("ddmc-channel", "applet");
        headers.put("ddmc-os-version", "[object Undefined]");
        headers.put("ddmc-app-client-id", "4");
        headers.put("cookie", "DDXQSESSID=d9d9e718795cd0c18e8add403069b18a");
        headers.put("ddmc-ip", "");
        headers.put("ddmc-longitude", "121.514587");
        headers.put("ddmc-latitude", "31.230208");
        headers.put("ddmc-api-version", "9.49.2");
        headers.put("ddmc-uid", "5cbe99c77d6690ee09a7ef36");
    ...
    public static Map getBody() {
        ...
        body.put("uid", "5cbe99c77d6690ee09a7ef36");
        body.put("longitude", "121.514587");
        body.put("latitude", "31.230208");
        body.put("station_id", "5b8d22f8c0a1ea3a278b8b7c");//这个是站点id 请仔细检查和确认这个参数 进入小程序之后首页左上角是不是你所在的站点 如果不是先选择好站点再抓包 不要把站点搞错了 否则不能下单
        ...
        body.put("sharer_uid", "");
        body.put("openid", "osP8I0Ye4h8s02pKunY83P4e9Sc8");
        body.put("h5_source", "");
        body.put("device_token", "WHJMrwNw1k/FKPjcOOgRd+B/G6PKbViqJisBpZ3wkZTq/ZmFjRjGVxB7b+QlrWQZh5+mEKcOg67Fb0d26LtxgVf8dBQXA0fXgdCW1tldyDzmauSxIJm5Txg==1487582755342");
        return body;
    }
